package com.zebra.rfidreader.demo.zebra.notifications;
...
public class NotificationsService extends IntentService {
    ...
    private void sendCustomBroadcast(Intent intent) {
        ...
        broadcast.putExtra(Constants.DATA_BLUETOOTH_DEVICE, String.valueOf(intent.getParcelableExtra(Constants.DATA_BLUETOOTH_DEVICE)));
        sendOrderedBroadcast(broadcast, null);
    }
}
