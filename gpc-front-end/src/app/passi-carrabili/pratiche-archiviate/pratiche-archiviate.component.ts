...
export class PraticheArchiviateComponent implements OnInit {
  ...
  titleTable: string = 'Pratiche archiviate';
  ...
  cercaPratiche(){
    ...
    this.passiCarrabiliService.cercaPratichePerStatoPratica(StatoPraticaPassiCarrabili.Archiviata, this.authService.getMunicipio()).subscribe(
      data => {
