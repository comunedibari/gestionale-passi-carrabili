...
@Component({
  selector: 'app-furto-deterioramento',
  templateUrl: './furto-deterioramento.component.html',
  styleUrls: ['./furto-deterioramento.component.css']
})
export class FurtoDeterioramentoComponent implements OnInit, OnDestroy {
  ...
  confermaDatiDialog() {
    this.confirmationService.confirm({
      ...
      header: "Regolarizzazione furto/deterioramento",
      message: "Confermi la motivazione inserita prima di continuare con l'upload dei documenti?",
      accept: () => {
  ...
  inserisciPratica(){
    ...
    pratica.dati_istanza.tipologia_processo = TipologiaPratica['Regolarizzazione furto/deterioramento']; 
