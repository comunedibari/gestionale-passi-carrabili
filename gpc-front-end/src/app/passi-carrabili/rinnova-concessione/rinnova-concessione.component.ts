...
@Component({
  selector: 'app-rinnova-concessione',
  templateUrl: './rinnova-concessione.component.html',
  styleUrls: ['./rinnova-concessione.component.css']
})
export class RinnovaConcessioneComponent implements OnInit, OnDestroy {
  ...
  inserisciPratica(){
    ...
    pratica.dati_istanza.tipologia_processo = TipologiaPratica.Rinnovo;  
