...
@Component({
  selector: 'app-rinuncia-concessione',
  templateUrl: './rinuncia-concessione.component.html',
  styleUrls: ['./rinuncia-concessione.component.css']
})
export class RinunciaConcessioneComponent implements OnInit, OnDestroy {
  ...
  inserisciPratica(){
    ...
    pratica.dati_istanza.tipologia_processo = TipologiaPratica.Rinuncia;  
