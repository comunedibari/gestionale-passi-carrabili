...
@Component({
  selector: 'app-pratiche-revocate',
  templateUrl: './pratiche-revocate.component.html',
  styleUrls: ['./pratiche-revocate.component.css']
})
export class PraticheRevocateComponent implements OnInit {
  ...
  titleTable: string = 'Pratiche revocate';
  exportName = 'Pratiche revocate'; 
  globalFilters: any[] = [
  ...
  cercaPratiche(){
    ...
    this.passiCarrabiliService.cercaPratichePerStatoPratica(StatoPraticaPassiCarrabili.Revocata, this.authService.getMunicipio()).subscribe(
      data => {
